...
// start types for compilerError
export interface CompilerError {
  compiler: string;
  human: string;
  solutions: Array<string>;
}
// end types for compilerError
...
export type DecltrTicker = Array<{
  [key: string]: Ticker;
}>;
